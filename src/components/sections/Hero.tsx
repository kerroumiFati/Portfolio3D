        ...
        <div className="flex flex-1 flex-row items-start justify-between">
          <div>
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hi, I'm <span id="hero-name" className="text-[#c94d4d] drop-shadow-[0_0_15px_rgba(201,77,77,0.5)] whitespace-nowrap">{config.hero.name}</span>
            </h1>
          ...
          <div className="hidden md:flex items-center justify-center flex-1 mt-[160px]">
            <div className="relative">
              ...
              <div className="absolute inset-0 rounded-full border-2 border-[#c94d4d]/30 animate-[spin_8s_linear_infinite]"
                style={{ width: "420px", height: "420px", top: "-60px", left: "-60px" }} />
              <div className="absolute inset-0 rounded-full border border-[#c94d4d]/20 animate-[spin_12s_linear_infinite_reverse]"
              ...
              <div className="relative flex items-center justify-center w-[300px] h-[300px] rounded-full
                ...
                border-4 border-[#c94d4d]/60
                shadow-[0_0_40px_rgba(201,77,77,0.4),inset_0_0_40px_rgba(201,77,77,0.05)]">
                <img
                  src={avatarPC}
                  alt="avatar"
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[#c94d4d] shadow-[0_0_12px_rgba(201,77,77,0.9)] animate-pulse" />
